@extends('layouts.app', ['page' => __('Add Product Recover'), 'pageSlug' => 'users', 'section' => 'users'])
            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <p class="mb-1">Add Product Recover</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Product Recover</h4>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <select id="part_name" name="part_name">
                                                        ...
                                                        @foreach($parts as $account)
                                                            <option value="{{$account->par_id}}" data-stock="{{$account->par_total_qty}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="parts_qty"
                                                           name="parts_qty" placeholder="Enter a Products Quantity.." onkeypress="return numbersOnly(event)">
                                                </div>
                                            </div>
